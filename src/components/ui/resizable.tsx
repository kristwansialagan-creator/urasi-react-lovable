...
const ResizablePanelGroup = ({ className, ...props }: React.ComponentProps<typeof ResizablePrimitive.Panel> & { direction?: "horizontal" | "vertical" }) => (
  <div
    className={cn("flex h-full w-full", props.direction === "vertical" ? "flex-col" : "", className)}
