...
const id: TranslationKeys = {
    ...
    registers: {
        title: 'Register',
        subtitle: 'Kelola register Anda',
        addRegister: 'Tambah Register',
        addRegisterDesc: 'Buat register baru untuk toko Anda.',
        registerName: 'Nama Register',
        registerNamePlaceholder: 'contoh: Register Utama',
        activeRegisters: 'Register Aktif',
        totalBalance: 'Total Saldo',
        totalRegisters: 'Total Register',
        closedRegisters: 'Register Tertutup',
        noRegisters: 'Belum ada register. Buat register pertama untuk memulai.',
        currentBalance: 'Saldo Saat Ini',
        open: 'Buka',
        closed: 'Tutup',
        openRegister: 'Buka Register',
        openRegisterDesc: 'Masukkan saldo awal untuk register ini.',
        openingBalance: 'Saldo Awal',
        closeRegister: 'Tutup Register',
        closeRegisterConfirm: 'Tutup Register?',
        closeRegisterConfirmDesc: 'Apakah Anda yakin ingin menutup register ini? Pastikan semua transaksi sudah dicatat.',
        cashIn: 'Kas Masuk',
        cashInDesc: 'Tambahkan uang ke register.',
        cashOut: 'Kas Keluar',
        cashOutDesc: 'Tarik uang dari register.',
